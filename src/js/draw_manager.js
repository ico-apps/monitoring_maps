...
(function(window){
  ...
  function MonitoringDraw.(){
    ...
    /* Hide @layer_id layer UNUSED at this time */
    ...
    */
    ...
    _drawMonitoringSiteObject.addGeoJSONDrawGeometry = function(geometry, _type, result_handler){

      if(geometry_manager.isValid(geometry, _type)){

        geometry_manager.addGeoJSONDrawGeometry(geometry, _type, editableLayers);
